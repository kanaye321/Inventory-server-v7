...
export const insertITEquipmentAssignmentSchema = createInsertSchema(itEquipmentAssignments).omit({ id: true });
...
export const storageMediaInventory = pgTable("storage_media_inventory", {
  id: serial("id").primaryKey(),
...
// Insert schemas for complex objects
...
export const insertAwsInventorySchema = createInsertSchema(awsInventory).omit({ id: true, createdAt: true, updatedAt: true });
export const insertAwsHistoricalDataSchema = createInsertSchema(awsHistoricalData).omit({ id: true, createdAt: true });
export const insertIamAccountSchema = createInsertSchema(iamAccounts).omit({ id: true, createdAt: true, updatedAt: true });
export const insertIamAccountApprovalHistorySchema = createInsertSchema(iamAccountApprovalHistory).omit({ id: true, actedAt: true });
export const insertApprovalNumberHistorySchema = createInsertSchema(vmApprovalHistory).omit({ id: true, createdAt: true });

export const insertAzureInventorySchema = createInsertSchema(azureInventory).omit({ id: true, createdAt: true, updatedAt: true });
export const insertGcpInventorySchema = createInsertSchema(gcpInventory).omit({ id: true, createdAt: true, updatedAt: true });
export const insertBitlockerKeySchema = createInsertSchema(bitlockerKeys).omit({ id: true, dateAdded: true, updatedAt: true });
export const insertVmInventorySchema = createInsertSchema(vmInventory).omit({ id: true, createdAt: true });
export const insertVmMonitoringSchema = createInsertSchema(vmMonitoring).omit({ id: true, createdAt: true, updatedAt: true });
export const insertMonitorSchema = createInsertSchema(monitorInventory).omit({ id: true, createdAt: true, updatedAt: true });
export const insertItEquipmentSchema = createInsertSchema(itEquipment).omit({ id: true, created_at: true, updated_at: true });
export const insertMonitoringDashboardSchema = createInsertSchema(monitoringDashboards).omit({ id: true, createdAt: true, updatedAt: true });
export const insertMonitoringDatasourceSchema = createInsertSchema(monitoringDatasources).omit({ id: true, createdAt: true, updatedAt: true });
export const insertMonitoringAlertRuleSchema = createInsertSchema(monitoringAlertRules).omit({ id: true, createdAt: true, updatedAt: true });
export const insertMonitoringPanelSchema = createInsertSchema(monitoringPanels).omit({ id: true, createdAt: true, updatedAt: true });
export const insertDiscoveredHostSchema = createInsertSchema(discoveredHosts).omit({ id: true, createdAt: true, updatedAt: true });
...
export type StorageMediaInventory = typeof storageMediaInventory.$inferSelect;
