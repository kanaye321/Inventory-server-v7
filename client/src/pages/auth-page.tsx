      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 lg:px-20 py-12">
          ...
          <div className="mb-16 space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl lg:text-4xl font-light text-slate-700 dark:text-slate-300">
                  Asset Management System
                </h2>
                <div className="w-32 h-1 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full animate-expand-width"></div>
              </div>

              <p className="text-slate-600 dark:text-slate-400 text-xl max-w-2xl leading-relaxed font-light">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl">
            {[
              ...
              <div key={index} className={`group animate-slide-in-left ${feature.delay}`}>
                <div className="flex items-start space-x-6 p-6 rounded-2xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-white/60 dark:border-gray-700/60 hover:bg-white/90 dark:hover:bg-gray-800/90 transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10 shadow-lg shadow-slate-200/50">
                  ...
                  <div className="flex-1">
                    <h3 className="text-slate-800 dark:text-slate-200 font-semibold text-lg mb-3 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
                      {feature.title}
                    </h3>
          ...
          <div className="mt-16 flex items-center space-x-8 opacity-70 animate-fade-in delay-1000">
            <div className="flex items-center space-x-2">
              <ServerIcon className="w-5 h-5 text-emerald-600" />
              <span className="text-sm text-slate-600 dark:text-slate-400">Network Discovery</span>
            </div>
            <div className="flex items-center space-x-2">
              <MonitorIcon className="w-5 h-5 text-blue-600" />
              <span className="text-sm text-slate-600 dark:text-slate-400">VM Monitoring</span>
            </div>
            <div className="flex items-center space-x-2">
              <ShieldCheckIcon className="w-5 h-5 text-purple-600" />
              <span className="text-sm text-slate-600 dark:text-slate-400">BitLocker Keys</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-[600px] flex items-center justify-center px-8 lg:px-16 py-16">
          <div className="w-full max-w-lg">
            <Card className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-slate-200/60 dark:border-gray-700/60 shadow-2xl shadow-slate-200/40 animate-slide-in-right overflow-hidden">
              {/* Card Header with Gradient */}
              <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 dark:from-gray-800/80 dark:to-gray-800/80 backdrop-blur-sm border-b border-slate-200/50 dark:border-gray-700/50">
                <CardHeader className="text-center pb-8 pt-12">
                  ...
                  <h2 className="text-slate-800 dark:text-slate-100 text-3xl font-bold mb-4 bg-gradient-to-r from-slate-800 to-emerald-700 dark:from-slate-100 dark:to-emerald-400 bg-clip-text text-transparent">
                    System Access
                  </h2>
              ...
              <CardContent className="space-y-8 px-12 py-10">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="grid w-full grid-cols-2 bg-slate-100/80 dark:bg-gray-800/80 border border-slate-200/60 dark:border-gray-700/60 mb-10 h-14 rounded-xl overflow-hidden backdrop-blur-sm">
                    <TabsTrigger
                      value="login"
                      className="text-slate-600 dark:text-slate-300 data-[state=active]:text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-600 data-[state=active]:to-teal-500 data-[state=active]:shadow-lg border-r border-slate-200/60 dark:border-gray-700/60 transition-all duration-300 font-medium text-base"
                    >
                      Sign In
                    </TabsTrigger>
                    <TabsTrigger
                      value="register"
                      className="text-slate-600 dark:text-slate-300 data-[state=active]:text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-600 data-[state=active]:to-teal-500 data-[state=active]:shadow-lg transition-all duration-300 font-medium text-base"
                    >
                      Register
                    </TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="login" className="space-y-8 animate-fade-in">
                    ...
                    <form onSubmit={handleLogin} className="space-y-8">
                      <div className="space-y-4">
                        <Label htmlFor="username" className="text-slate-700 dark:text-slate-300 text-base font-medium">
                          Username
                        </Label>
                        <Input
                          id="username"
                          ...
                          className="bg-slate-50/80 dark:bg-gray-800/80 border-slate-200 dark:border-gray-700 text-slate-800 dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 h-14 rounded-xl text-base backdrop-blur-sm transition-all duration-300 hover:bg-slate-50 dark:hover:bg-gray-800 focus:bg-white dark:focus:bg-gray-800"
                      ...
                      <div className="space-y-4">
                        <Label htmlFor="password" className="text-slate-700 dark:text-slate-300 text-base font-medium">
                          Password
                        </Label>
                        <div className="relative">
                          <Input
                            ...
                            className="bg-slate-50/80 dark:bg-gray-800/80 border-slate-200 dark:border-gray-700 text-slate-800 dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 pr-14 h-14 rounded-xl text-base backdrop-blur-sm transition-all duration-300 hover:bg-slate-50 dark:hover:bg-gray-800 focus:bg-white dark:focus:bg-gray-800"
                          ...
                          <Button
                            ...
                            variant="ghost"
                            size="icon"
                            className="absolute right-4 top-1/2 -translate-y-1/2 h-10 w-10 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100/60 dark:hover:bg-gray-700/60 rounded-lg transition-all duration-200"
                    ...
                    <form onSubmit={handleMfaVerify} className="space-y-8">
                      ...
                      <div className="space-y-4">
                        <Label htmlFor="mfaCode" className="text-slate-700 dark:text-slate-300 text-base font-medium">
                          Verification Code
                        </Label>
                        <Input
                          id="mfaCode"
                          ...
                          maxLength={6}
                          placeholder="000000"
                          className="bg-slate-50/80 dark:bg-gray-800/80 border-slate-200 dark:border-gray-700 text-slate-800 dark:text-slate-100 text-center text-2xl tracking-widest font-mono h-14 rounded-xl"
                          value={mfaCode}
                ...
                <div className="text-center pt-6 border-t border-slate-200/60 dark:border-gray-700/60">
