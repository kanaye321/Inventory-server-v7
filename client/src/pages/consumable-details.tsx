              ...
              <CardContent className="grid gap-6">
                ...
                {consumable.notes && (
                  <div>
                    ...
                    <p className="mt-1 text-sm bg-gray-50 dark:bg-gray-800 p-3 rounded-md">{consumable.notes}</p>
                  </div>
                )}
              </CardContent>
            </Card>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                          ...
                          {assignment.notes && (
                            <div className="md:col-span-4">
                              ...
                              <p className="text-sm bg-gray-50 dark:bg-gray-800 p-2 rounded">{assignment.notes}</p>
                            </div>
                          )}
                        </div>
