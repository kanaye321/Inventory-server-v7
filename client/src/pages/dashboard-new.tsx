      ...
      <div className="max-w-[1920px] mx-auto px-6 py-6 space-y-6">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
              ...
              <CardContent className="pt-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">IT Equipment</p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Monitors</p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Azure Resources</p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">GCP Resources</p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">AWS Resources</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="vm" className="space-y-6">
            <Card className="shadow-xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
              <CardHeader className="border-b bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-950 dark:to-indigo-950">
                <CardTitle className="flex items-center gap-2">
