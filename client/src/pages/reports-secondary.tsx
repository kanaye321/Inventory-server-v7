                ...
                <Card className="border-2 border-purple-100 dark:border-purple-900">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'Laptop' })} className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-6 rounded-xl border-2 border-green-200 dark:border-green-800 text-center hover:shadow-lg transition-all cursor-pointer">
                        <p className="text-4xl font-bold text-green-700 dark:text-green-400 mb-2">{ageDistribution.new}</p>
                        <p className="text-sm font-medium text-green-800 dark:text-green-300">New (≤1 year)</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'Laptop' })} className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-6 rounded-xl border-2 border-blue-200 dark:border-blue-800 text-center hover:shadow-lg transition-all cursor-pointer">
                        <p className="text-4xl font-bold text-blue-700 dark:text-blue-400 mb-2">{ageDistribution.good}</p>
                        <p className="text-sm font-medium text-blue-800 dark:text-blue-300">Good (1-3 years)</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'Laptop' })} className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-950 dark:to-yellow-900 p-6 rounded-xl border-2 border-yellow-200 dark:border-yellow-800 text-center hover:shadow-lg transition-all cursor-pointer">
                        <p className="text-4xl font-bold text-yellow-700 dark:text-yellow-400 mb-2">{ageDistribution.aging}</p>
                        <p className="text-sm font-medium text-yellow-800 dark:text-yellow-300">Aging (3-5 years)</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'Laptop' })} className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 p-6 rounded-xl border-2 border-red-200 dark:border-red-800 text-center hover:shadow-lg transition-all cursor-pointer">
                        <p className="text-4xl font-bold text-red-700 dark:text-red-400 mb-2">{ageDistribution.old}</p>
                        <p className="text-sm font-medium text-red-800 dark:text-red-300">Old (&gt;5 years)</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-blue-100 dark:border-blue-900">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop', statusFilter: 'available' })} className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-4 rounded-lg border-2 border-green-200 dark:border-green-800 cursor-pointer">
                        <p className="text-sm text-green-700 dark:text-green-400 mb-1">On-Hand</p>
                        <p className="text-3xl font-bold text-green-800 dark:text-green-300">{laptopStats.onHand}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop', statusFilter: 'Deployed' })} className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-4 rounded-lg border-2 border-blue-200 dark:border-blue-800 cursor-pointer">
                        <p className="text-sm text-blue-700 dark:text-blue-400 mb-1">Deployed</p>
                        <p className="text-3xl font-bold text-blue-800 dark:text-blue-300">{laptopStats.deployed}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop', statusFilter: 'pending' })} className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-950 dark:to-yellow-900 p-4 rounded-lg border-2 border-yellow-200 dark:border-yellow-800 cursor-pointer">
                        <p className="text-sm text-yellow-700 dark:text-yellow-400 mb-1">Pending</p>
                        <p className="text-3xl font-bold text-yellow-800 dark:text-yellow-300">{laptopStats.pendingDeployment}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop', conditionFilter: 'Good' })} className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 p-4 rounded-lg border-2 border-emerald-200 dark:border-emerald-800 cursor-pointer">
                        <p className="text-sm text-emerald-700 dark:text-emerald-400 mb-1">Good Condition</p>
                        <p className="text-3xl font-bold text-emerald-800 dark:text-emerald-300">{laptopStats.goodCondition}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop', conditionFilter: 'Bad' })} className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 p-4 rounded-lg border-2 border-red-200 dark:border-red-800 cursor-pointer">
                        <p className="text-sm text-red-700 dark:text-red-400 mb-1">Bad Condition</p>
                        <p className="text-3xl font-bold text-red-800 dark:text-red-300">{laptopStats.badCondition}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop', statusFilter: 'Reserved' })} className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-800 cursor-pointer">
                        <p className="text-sm text-purple-700 dark:text-purple-400 mb-1">Reserved</p>
                        <p className="text-3xl font-bold text-purple-800 dark:text-purple-300">{laptopStats.reserved}</p>
                      </div>
                ...
                <Card className="border-2 border-purple-100 dark:border-purple-900">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', statusFilter: 'available' })} className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-4 rounded-lg border-2 border-green-200 dark:border-green-800 cursor-pointer">
                        <p className="text-sm text-green-700 dark:text-green-400 mb-1">On-Hand</p>
                        <p className="text-3xl font-bold text-green-800 dark:text-green-300">{desktopStats.onHand}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', statusFilter: 'Deployed' })} className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-4 rounded-lg border-2 border-blue-200 dark:border-blue-800 cursor-pointer">
                        <p className="text-sm text-blue-700 dark:text-blue-400 mb-1">Deployed</p>
                        <p className="text-3xl font-bold text-blue-800 dark:text-blue-300">{desktopStats.deployed}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', statusFilter: 'pending' })} className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-950 dark:to-yellow-900 p-4 rounded-lg border-2 border-yellow-200 dark:border-yellow-800 cursor-pointer">
                        <p className="text-sm text-yellow-700 dark:text-yellow-400 mb-1">Pending</p>
                        <p className="text-3xl font-bold text-yellow-800 dark:text-yellow-300">{desktopStats.pendingDeployment}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', conditionFilter: 'Good' })} className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 p-4 rounded-lg border-2 border-emerald-200 dark:border-emerald-800 cursor-pointer">
                        <p className="text-sm text-emerald-700 dark:text-emerald-400 mb-1">Good Condition</p>
                        <p className="text-3xl font-bold text-emerald-800 dark:text-emerald-300">{desktopStats.goodCondition}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', conditionFilter: 'Bad' })} className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 p-4 rounded-lg border-2 border-red-200 dark:border-red-800 cursor-pointer">
                        <p className="text-sm text-red-700 dark:text-red-400 mb-1">Bad Condition</p>
                        <p className="text-3xl font-bold text-red-800 dark:text-red-300">{desktopStats.badCondition}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', statusFilter: 'Reserved' })} className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-800 cursor-pointer">
                        <p className="text-sm text-purple-700 dark:text-purple-400 mb-1">Reserved</p>
                        <p className="text-3xl font-bold text-purple-800 dark:text-purple-300">{desktopStats.reserved}</p>
                      </div>
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop', statusFilter: 'Deployed' })} className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-950 dark:to-indigo-900 p-4 rounded-lg border-2 border-indigo-200 dark:border-indigo-800 cursor-pointer">
                        <p className="text-sm text-indigo-700 dark:text-indigo-400 mb-1">Utilization</p>
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                      <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-4 rounded-lg border-2 border-blue-200 dark:border-blue-800">
                        <p className="text-sm text-blue-700 dark:text-blue-400 mb-1">Total Assets</p>
                        <p className="text-3xl font-bold text-blue-800 dark:text-blue-300">{dateRangeStats.total}</p>
                      </div>
                      <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-800">
                        <p className="text-sm text-purple-700 dark:text-purple-400 mb-1">Laptops</p>
                        <p className="text-3xl font-bold text-purple-800 dark:text-purple-300">{dateRangeStats.laptops}</p>
                      </div>
                      <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-4 rounded-lg border-2 border-green-200 dark:border-green-800">
                        <p className="text-sm text-green-700 dark:text-green-400 mb-1">Desktops</p>
                        <p className="text-3xl font-bold text-green-800 dark:text-green-300">{dateRangeStats.desktops}</p>
                      </div>
                      <div className="bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-950 dark:to-teal-900 p-4 rounded-lg border-2 border-teal-200 dark:border-teal-800">
                        <p className="text-sm text-teal-700 dark:text-teal-400 mb-1">Deployed</p>
                        <p className="text-3xl font-bold text-teal-800 dark:text-teal-300">{dateRangeStats.deployed}</p>
                      </div>
                      <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-950 dark:to-yellow-900 p-4 rounded-lg border-2 border-yellow-200 dark:border-yellow-800">
                        <p className="text-sm text-yellow-700 dark:text-yellow-400 mb-1">Available</p>
                        <p className="text-3xl font-bold text-yellow-800 dark:text-yellow-300">{dateRangeStats.available}</p>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3 max-h-[600px] overflow-y-auto custom-scrollbar pr-2">
                        {dateRangeAssets.map((asset) => (
                          <div
                            ...
                            className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-700 hover:shadow-md transition-all cursor-pointer"
                          >
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Asset Tag: {asset.assetTag}</p>
                                <div className="flex gap-2 mt-2">
                                  <Badge className="bg-blue-100 text-blue-800 border-blue-300 dark:bg-blue-900 dark:text-blue-300 dark:border-blue-700">
                                    {asset.category}
                                  </Badge>
                                  <Badge className={asset.status === 'Deployed' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300'}>
                                    {asset.status}
                                  </Badge>
                                </div>
                              </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                              <div>
                                ...
                                <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{asset.model || 'N/A'}</p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{asset.serialNumber || 'N/A'}</p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Department</p>
                                <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{asset.department || 'N/A'}</p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Condition</p>
                                <Badge className={asset.condition === 'Good' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'}>
                                  {asset.condition || 'N/A'}
                                </Badge>
                              </div>
                            </div>
                ...
                <Tabs defaultValue="category1" className="w-full">
                              ...
                              {usersWithOldSingleLaptop.map(({ knoxId, assets: userAssets }) => {
                                ...
                                return (
                                  <div
                                    ...
                                    className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-md transition-all cursor-pointer"
                                  >
                                    <div className="flex items-start justify-between mb-4">
                                      <div className="flex-1">
                                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 text-lg">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4 border-t border-gray-200">
                                      <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Asset Tag</p>
                                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userLaptop?.assetTag || 'N/A'}</p>
                                      </div>
                                      <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Device Name</p>
                                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userLaptop?.name || 'N/A'}</p>
                                      </div>
                                      <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
                                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userLaptop?.model || 'N/A'}</p>
                                      </div>
                                      <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userLaptop?.serialNumber || 'N/A'}</p>
                                      </div>
                                      <div>
                  ...
                  <TabsContent value="category2">
                    ...
                    <Card className="border-2 border-purple-100 dark:border-purple-900">
                      ...
                      <CardContent className="p-6">
                        <div className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950 p-6 rounded-xl border-2 border-purple-200 dark:border-purple-800">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-sm text-purple-700 dark:text-purple-400 mb-1">Total Users Identified</p>
                              <p className="text-4xl font-bold text-purple-900 dark:text-purple-300">{usersWithDesktopAndOldLaptop.length}</p>
                              <p className="text-xs text-purple-600 dark:text-purple-400 mt-2">Users with 1 desktop and 1 laptop (5+ years old)</p>
                            </div>
                              ...
                              {usersWithDesktopAndOldLaptop.map(({ knoxId, assets: userAssets }) => {
                                ...
                                return (
                                  <div
                                    key={knoxId}
                                    onClick={() => navigateWithFilters({ search: knoxId })}
                                    className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-md transition-all cursor-pointer"
                                  >
                                    <div className="flex items-start justify-between mb-4">
                                      <div className="flex-1">
                                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 text-lg">
                                    ...
                                    <div className="space-y-4">
                                      <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <p className="text-xs font-semibold text-blue-700 dark:text-blue-400 mb-3 flex items-center gap-2">
                                          <Laptop className="h-4 w-4" />
                                          LAPTOP DETAILS
                                        </p>
                                      ...
                                      <div className="bg-green-50 dark:bg-green-950 p-4 rounded-lg border border-green-200 dark:border-green-800">
                                        <p className="text-xs font-semibold text-green-700 dark:text-green-400 mb-3 flex items-center gap-2">
                                          <Monitor className="h-4 w-4" />
                                          DESKTOP DETAILS
                                        </p>
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Asset Tag</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userDesktop?.assetTag || 'N/A'}</p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userDesktop?.model || 'N/A'}</p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{userDesktop?.serialNumber || 'N/A'}</p>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                  ...
                  <TabsContent value="category3">
                    ...
                    <Card className="border-2 border-green-100 dark:border-green-900">
                      ...
                      <CardContent className="p-6">
                        <div className="mb-6 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-950 dark:to-teal-950 p-6 rounded-xl border-2 border-green-200 dark:border-green-800">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-sm text-green-700 dark:text-green-400 mb-1">Total Users Identified</p>
                              <p className="text-4xl font-bold text-green-900 dark:text-green-300">{usersWithTwoLaptopsNoDesktop.length}</p>
                              <p className="text-xs text-green-600 dark:text-green-400 mt-2">Users with exactly 2 laptops and no desktop</p>
                            </div>
                              ...
                              {usersWithTwoLaptopsNoDesktop.map(({ knoxId, assets: userAssets }) => {
                                ...
                                return (
                                  <div
                                    key={knoxId}
                                    onClick={() => navigateWithFilters({ search: knoxId })}
                                    className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-green-300 dark:hover:border-green-700 hover:shadow-md transition-all cursor-pointer"
                                  >
                                    <div className="flex items-start justify-between mb-4">
                                      <div className="flex-1">
                                        <h4 className="font-semibold text-gray-900 dark:text-gray-100 text-lg">
                                    ...
                                    <div className="space-y-4">
                                      <div className="bg-indigo-50 dark:bg-indigo-950 p-4 rounded-lg border border-indigo-200 dark:border-indigo-800">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Asset Tag</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{laptop1?.assetTag || 'N/A'}</p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{laptop1?.model || 'N/A'}</p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{laptop1?.serialNumber || 'N/A'}</p>
                                          </div>
                                        </div>
                                      </div>

                                      <div className="bg-cyan-50 dark:bg-cyan-950 p-4 rounded-lg border border-cyan-200 dark:border-cyan-800">
                                        <p className="text-xs font-semibold text-cyan-700 dark:text-cyan-400 mb-3 flex items-center gap-2">
                                          <Laptop className="h-4 w-4" />
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Asset Tag</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{laptop2?.assetTag || 'N/A'}</p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{laptop2?.model || 'N/A'}</p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{laptop2?.serialNumber || 'N/A'}</p>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                      ...
                                      <div className="space-y-4">
                                        <div className="bg-red-50 dark:bg-red-950 p-4 rounded-lg border border-red-200 dark:border-red-800">
                                          ...
                                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                            <div>
                                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Asset Tag</p>
                                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{oldLaptop?.assetTag || 'N/A'}</p>
                                            </div>
                                            <div>
                                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
                                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{oldLaptop?.model || 'N/A'}</p>
                                            </div>
                                            <div>
                                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{oldLaptop?.serialNumber || 'N/A'}</p>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                                          ...
                                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                            <div>
                                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Asset Tag</p>
                                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{newLaptop?.assetTag || 'N/A'}</p>
                                            </div>
                                            <div>
                                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
                                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{newLaptop?.model || 'N/A'}</p>
                                            </div>
                                            <div>
                                              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Serial Number</p>
                                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{newLaptop?.serialNumber || 'N/A'}</p>
                                            </div>
                                          </div>
                                        </div>
