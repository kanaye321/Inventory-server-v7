...
import { PlusIcon, CheckCircleIcon, KeyIcon, Trash2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Licenses</h1>
          ...
          {isLoading ? (
            ...
            <div className="grid gap-4">
              {licenses.map((license) => (
                <div key={license.id} className="border rounded-lg p-4 bg-white dark:bg-gray-800 shadow-sm dark:border-gray-700">
                  <div className="flex flex-col md:flex-row justify-between">
                    <div className="flex-1">
                      <h3 className="font-medium text-lg">{license.name}</h3>
                      <div className="flex items-center gap-1 text-sm text-gray-500 mt-1">
                        <KeyIcon className="h-4 w-4" />
                        <span className="font-mono">{license.key ? license.key.substring(0, 16) + '...' : 'N/A'}</span>
                      </div>
