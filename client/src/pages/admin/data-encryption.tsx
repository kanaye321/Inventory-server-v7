        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
              <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">What gets encrypted:</h4>
              ...
              <p className="text-sm text-blue-700 dark:text-blue-400 mt-2 font-medium">Note: Knox IDs are NOT encrypted</p>
            </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
            <h4 className="font-medium text-green-900 dark:text-green-300 mb-2">Security Features:</h4>
