          ...
          <Card>
            ...
            {databaseStatus?.connectionError ? (
              <div className="text-center py-8">
                ...
                {databaseStatus?.errorMessage && (
                  <div className="mt-3 p-3 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg">
                    <p className="text-sm text-red-700 dark:text-red-400 font-medium">Error Details:</p>
                    <p className="text-sm text-red-600 dark:text-red-400">{databaseStatus.errorMessage}</p>
                  </div>
                )}
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 dark:text-gray-400">Checking database status...</p>
              </div>
            ) : (
              databaseStatus ? (
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <h3 className="font-medium text-green-800 dark:text-green-300">Storage Mode</h3>
                    </div>
                    <p className="mt-2 text-green-700 dark:text-green-400">{databaseStatus.storageMode}</p>
                ...
                <div className="border rounded-md p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {scheduleMaintenanceMutation.isPending && (
                      <div className="mt-4 p-3 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-md flex items-center">
