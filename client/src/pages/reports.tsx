      ...
      <div className="space-y-8 p-6 animate-in fade-in-0 duration-700">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
          <div className="space-y-2 animate-in slide-in-from-left-5 duration-700">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 font-medium">Comprehensive device analytics and department summaries</p>
          </div>
          <div className="flex flex-wrap gap-3 animate-in slide-in-from-right-5 duration-700">
            ...
            <Button
              ...
              className="border-green-200 text-green-600 hover:bg-green-50 dark:border-green-700 dark:text-green-400 dark:hover:bg-green-900"
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-3">
                ...
                <div className="border rounded-lg p-4 bg-slate-50 dark:bg-slate-800/50 max-h-96 overflow-auto">
                    ...
                    <div className="text-center py-12">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-slate-500 dark:text-slate-400">No data available for this report type</p>
                          <p className="text-xs text-slate-400 dark:text-slate-500">Try selecting a different report type or check your data sources</p>
                        </div>
                      </div>
                    </div>
                  )}
