  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="space-y-8 p-6 animate-in fade-in-0 duration-700">
          ...
          <div className="flex flex-wrap gap-3 animate-in slide-in-from-right-5 duration-700">
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="w-[95%] max-w-4xl max-h-[90vh] overflow-y-auto animate-in fade-in-0 zoom-in-95 duration-300">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-bold text-slate-800 dark:text-gray-100">Add New Consumable</DialogTitle>
        ...
        <Card className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 animate-in slide-in-from-bottom-8 delay-200">
          <CardHeader className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border-b border-indigo-100 dark:border-gray-700">
            <CardTitle className="text-2xl font-bold text-slate-800 dark:text-gray-100 flex items-center gap-3">
          ...
          <CardContent className="p-6">
            ...
            {isLoading ? (
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <CardTitle className="text-lg font-bold text-slate-800 dark:text-gray-100 group-hover:text-indigo-600 transition-colors">
                            {consumable.name}
                          </CardTitle>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div className="bg-slate-50 dark:bg-gray-800 rounded-lg p-3 border border-slate-200 dark:border-gray-700">
                          <p className="text-xs text-slate-600 dark:text-gray-400 font-medium mb-1">Location</p>
                          <p className="text-sm font-semibold text-slate-900 dark:text-gray-100 truncate">{consumable.location || 'N/A'}</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-gray-800 rounded-lg p-3 border border-slate-200 dark:border-gray-700">
                          <p className="text-xs text-slate-600 dark:text-gray-400 font-medium mb-1">Manufacturer</p>
                          <p className="text-sm font-semibold text-slate-900 dark:text-gray-100 truncate">{consumable.manufacturer || 'N/A'}</p>
                        </div>
                      </div>
              ...
              <div className="text-center py-16 animate-in fade-in-0 duration-700">
                ...
                <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-3">No results found</h3>
                <p className="text-slate-600 dark:text-gray-400 mb-4">No consumables match your search criteria.</p>
              ...
              <div className="text-center py-16 animate-in fade-in-0 duration-700">
                ...
                <h3 className="text-2xl font-bold text-slate-800 dark:text-gray-100 mb-3">No Consumables Found</h3>
                <p className="text-slate-600 dark:text-gray-400 mb-8 text-lg max-w-md mx-auto">
