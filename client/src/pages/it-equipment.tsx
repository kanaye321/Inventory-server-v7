                ...
                {paginatedEquipment.length > 0 ? (
                  ...
                  <Card>
                    <CardContent className="text-center py-10">
                      <MonitorIcon className="h-16 w-16 mx-auto text-gray-300 dark:text-gray-600 mb-4" />
                      <p className="text-gray-500 dark:text-gray-400">No equipment found matching your search.</p>
                    </CardContent>
                  </Card>
                )}
              </div>
