      ...
      <div className="p-5">
        {isLoading ? (
          <div className="animate-pulse space-y-4">
            <div className="h-10 bg-gray-100 dark:bg-gray-700 w-full rounded"></div>
            {[...Array(5)].map((_, i) => (
              <div key={i} className="h-12 bg-gray-50 dark:bg-gray-800 w-full rounded"></div>
            ))}
          </div>
          ...
          <div className="py-32 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-1">No assets found</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-4">No assets exist in the database</p>
          ...
          <div className="py-32 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-1">No assets found</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-4">Get started by creating your first asset</p>
            <Link href="/assets?add=true">
              <Button>
                <PlusIcon className="mr-2 h-4 w-4" />
                Add Asset
